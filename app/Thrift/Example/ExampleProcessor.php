...
class ExampleProcessor {
  ...
  protected function process_ping($seqid, $input, $output) {
    ...
    if ($bin_accel)
    {
      $args = thrift_protocol_read_binary_after_message_begin($input, '\App\Thrift\Example\Example_ping_args', $input->isStrictRead());
    }
    else
    {
  ...
  protected function process_say($seqid, $input, $output) {
    ...
    if ($bin_accel)
    {
      $args = thrift_protocol_read_binary_after_message_begin($input, '\App\Thrift\Example\Example_say_args', $input->isStrictRead());
    }
    else
    {
